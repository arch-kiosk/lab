      ...
      return context.layouter.renderElement(
        ...
        html`
          ...
          <div style="${cssStyle ? cssStyle : nothing}" class="read-only-image ${htmlClass}">
            <div
              class="${imageElement.align_image === "left" || imageElement.fit_content === "scale"
                ? "image-left-align"
                : "image-center"}"
            >
              ${value
            ...
            ${alignFileDescription === "bottom" && description
              ? html` <div class="file-element-description">${description}</div> `
              : nothing}
          </div>
        `,
      )
