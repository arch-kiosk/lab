ui_schema = {
  ...
  dsd: {
    collected_material: {
      ...
      cm_type: ["datatype(VARCHAR)", "label(type)"],
    ...
    locus: {
      ...
      created: ["datatype(TIMESTAMP)", "replfield_created()"],
      date_closed: ["datatype(DATE)", 'label("closing date")'],
      date_defined: ["datatype(DATE)", 'label("opening date")'],
      ...
      excavated_with: ["datatype(VARCHAR)"],
      ...
      type: ["datatype(VARCHAR)", "label('locus type')", "lookup('locus_types', 'id')"],
      uid: ["datatype(UUID)", "replfield_uuid()"],
    ...
    site: {
      arch_context: ["datatype(VARCHAR)", "identifier()", 'label("site")'],
      arch_domain: ["datatype(VARCHAR)", 'id_domain("arch_context")'],
      created: ["datatype(TIMESTAMP)", "replfield_created()"],
      id: ["datatype(VARCHAR)", 'label("name of site")'],
      id_short: ["datatype(VARCHAR)", 'local_id("arch_context")'],
      modified: ["datatype(TIMESTAMP)", "replfield_modified()"],
      modified_by: ["datatype(VARCHAR)", "replfield_modified_by()", "default(null)"],
      purpose: ["datatype(VARCHAR)"],
      uid: ["datatype(UUID)", "replfield_uuid()"],
      uid_site_map: ["datatype(UUID)", "uid_file()", 'label("site map")'],
    },
    small_find: {
      colour: ["datatype(VARCHAR)"],
    ...
    unit: {
      arch_context: ["datatype(VARCHAR)", "identifier()", 'label("#(unit/term_for_unit)")'],
      ...
      id: ["datatype(NUMBER)", 'local_id("arch_context")'],
      id_excavator: ["datatype(VARCHAR)", 'label("#($/constants/labels/label_supervisor)")'],
      id_site: ["datatype(VARCHAR)", 'join("site","id")', 'label("site")'],
      ...
      method: ["datatype(VARCHAR)", 'label("recording method")'],
      modified: ["datatype(TIMESTAMP)", "replfield_modified()"],
      modified_by: ["datatype(VARCHAR)", "replfield_modified_by()", "default(null)"],
      ...
      uid: ["datatype(UUID)", "replfield_uuid()"],
      unit_creation_date: ["datatype(DATE)", 'label("opened on")'],
    },
  },
  layout_settings: {
    default_element_visibility: true,
    orchestration_strategy: "columns",
    order: ["external_id", "line_1", "length", "modified_by", "modified", "created", "uid"],
    readonly: true,
  },
  meta: {
    scenario: "view",
